...
A `querier` is the `nukak`'s abstraction over database drivers to dynamically generate the queries. It allows interacting with the different databases in a consistent way.
