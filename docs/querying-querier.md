...
A `querier` is the `nukak`'s abstraction over database drivers to dynamically generate the queries for any given entity. It allows interacting with the different databases in a consistent way.
